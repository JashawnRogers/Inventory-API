...
public class StockMovement {
    ...
    public static StockMovement decreaseByAdjustment(StockItem stockItem,
                                                     Employee performedByEmployee,
                                                     Department optionalDepartment,
                                                     int quantity,
                                                     String reason,
    ...
    public static StockMovement transferIn(StockItem stockItem,
                                           Employee performedByEmployee,
                                           int quantity,
                                           String reason,
                                           String reference) {
    ...
    public static StockMovement transferOut(StockItem stockItem,
                                           Employee performedByEmployee,
                                           int quantity,
                                           String reason,
                                           String reference) {
